...
project = 'GeLoc'
copyright = '2022, Summo'
author = 'Summo'

github_doc_root = 'https://github.com/SouthGreenPlatform/GeLoc/tree/master/docs/'
issues_github_path = 'https://github.com/SouthGreenPlatform/GeLoc/issues'
...
html_short_title = "GeLoc"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
#
html_logo = '_images/geloc_logo.png'
